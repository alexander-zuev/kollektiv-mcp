...
Check out the sections below to see client-specific instructions.
...
![Cursor MCP Configuration](https://github.com/user-attachments/assets/b5f4ab86-1a84-475d-a191-4ad0e1f8e965)
...
4. **Restart your MCP client and try to reconnec to the MCP server:**
    - What this does:
...
Kollektiv MCP is part of a modular system enabling users to setup RAG over their data
