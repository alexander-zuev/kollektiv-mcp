/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9794582cefb79421ad0838fb27043cfd)
// Runtime types generated with workerd@1.20250508.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		API_BASE_URL: "http://localhost:8080" | "https://api.thekollektiv.ai";
		SITE_URL: "http://localhost:8787" | "https://mcp.thekollektiv.ai" | "https://kollektiv-mcp.azuev.workers.dev";
		PNPM_VERSION: "10.11.0";
		SUPABASE_URL: string;
		SUPABASE_ANON_KEY: string;
		COOKIE_SIGNING_SECRET: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").KollektivMCP>;
		ASSETS: Fetcher;
	}
}
