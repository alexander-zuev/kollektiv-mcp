/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3057386c8ceec2374d05769e1be4e753)
// Runtime types generated with workerd@1.20250709.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		kollektiv_oauth: KVNamespace;
		...
		MCP_OBJECT: DurableObjectNamespace<import("./src/worker/index").KollektivMCP>;
		kollektiv_rag: R2Bucket;
		D1: D1Database;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PNPM_VERSION" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "COOKIE_SIGNING_SECRET" | "SITE_URL" | "RESEND_API_KEY" | "BETTER_AUTH_SECRET">> {}
}
...
/**
 * An abnormal event (called an exception) which occurs as a result of calling a method or accessing a property of a api API.
 *
...
/**
 * Provides information about files and allows JavaScript in a api page to access their content.
 *
...
// `Disposable` was added to TypeScript's standard common types in version 5.2.
// To support older TypeScript versions, define an empty `Disposable` interface.
// Users won't be able to use `using`/`Symbol.dispose` without upgrading to 5.2,
// but this will ensure type checking on older versions still passes.
// TypeScript's interface merging will ensure our empty interface is effectively
// ignored when `Disposable` is included in the standard common.
