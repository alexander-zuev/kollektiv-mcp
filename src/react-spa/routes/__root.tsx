        ...
        <div
            ...
            <div className="w-full max-w-md rounded-lg bg-card p-8 shadow-lg">
                <div className="mb-6 flex justify-center">
                    ...
                    <div
                        className="bg-warning/20 border-warning/50 shadow-warning/10 flex h-16 w-16 items-center justify-center rounded-full border shadow-lg transition-all duration-300 hover:scale-105">
                        <svg
