      ...
      <main className="section-padding container-max-w-4xl flex-1">
        <article className="flex flex-col gap-lg">
          ...
          <section className="flex flex-col gap-sm">
            <p>
              At Sensr, operated by Kollektiv LLC, we take your privacy seriously. This Privacy
          ...
          <section className="flex flex-col gap-md">
            ...
            <div className="flex flex-col gap-sm">
              ...
              <p>
                When you create an account, we collect your email address through Supabase Auth and
                any tracking preferences you configure.
              </p>

              <h3 className="text-xl font-medium">Tracking Data</h3>
              <p>
                We store information about products you choose to track, including URLs, price
                thresholds, and notification preferences. This data is stored in our Supabase
                database.
              </p>
              ...
              <p>
                We use Firecrawl to scrape product information from websites you specify. We do not
                store personal information from these third-party sites, only product data (names,
                prices, availability).
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-md">
            ...
            <div className="flex flex-col gap-sm">
              ...
              <p>
                We use your information to provide our core price tracking service, including
                monitoring products, detecting price changes, and sending notifications when your
                specified conditions are met.
              </p>

              <h3 className="text-xl font-medium">Communication</h3>
              <p>
                We use your email address to send you price alerts, service announcements, and
                important account information. All notification preferences can be managed in your
                account settings.
              </p>
          ...
          <section className="flex flex-col gap-md">
            ...
            <div className="flex flex-col gap-sm">
              ...
              <p>
                ...
                including providers for database hosting, user authentication, web scraping, hosting
          ...
          <section className="flex flex-col gap-md">
            ...
            <div className="flex flex-col gap-sm">
              ...
              <p>
                ...
                settings. You can also modify your tracking preferences and notification settings at
                any time.
              </p>
          ...
          <section className="flex flex-col gap-md">
            ...
            <div className="flex flex-col gap-sm">
              ...
              <p>
                ...
                <br />
                <strong>Address:</strong> 701 Tillery Street Unit 12, 2874, Austin, TX 78702
              </p>
