...
import { CodeIcon, StorefrontIcon, BellIcon, HandCoinsIcon } from '@phosphor-icons/react';
import { LandingLayout } from '@/components/layouts';
import { Header, Footer, WaitlistForm } from '@/features/landing/components';
import { useEffect, useState } from 'react';
import { SignInModal } from '@/features/auth/components/SignInModal.tsx';
  ...
  return (
    <LandingLayout>
      ...
      <main className="flex flex-1 flex-col">
        ...
        >
          {/* Hero Badge */}
          <div className="inline-flex animate-in items-center gap-2 rounded-full border border-accent/20 bg-accent/10 px-4 py-2 text-sm font-medium text-accent duration-700 fade-in slide-in-from-bottom-4">
            <HandCoinsIcon className="h-4 w-4" />
            Save money with automated price tracking
          </div>

          {/* Hero Content */}
          <div className="max-w-3xl animate-in flex flex-col gap-lg delay-100 duration-700 fade-in slide-in-from-bottom-4">
            <h1 className="text-balance">
              Personal price tracker for the{' '}
              <span className="font-bold text-accent">entire internet</span>
            </h1>
            <p className="text-xl leading-relaxed text-muted-foreground">
              Automated price tracking for any product on (almost) any site. Get instant
          ...
          <div className="flex flex-col w-full justify-center items-center gap-sm pt-4">
            <Button size="xl" className="gap-2 max-w-md w-full text-xl font-semibold" asChild>
        ...
        <section id="demo" className="section-padding flex flex-col gap-12">
          ...
          <div className="grid gap-xl md:grid-cols-3 cursor-pointer">
            <div className="group bg-surface hover:bg-surface-hover flex flex-col gap-md rounded-xl border card-padding">
            ...
            <div className="group bg-surface/50 hover:bg-surface-hover flex flex-col gap-md rounded-xl border card-padding">
        ...
        <section id="pricing" className="section-padding flex flex-col gap-12">
          <div className="animate-in flex flex-col gap-md text-center duration-700 fade-in slide-in-from-bottom-4">
            <h2 className="flex items-center justify-center gap-2">
          ...
          <div className="mx-auto max-w-4xl">
            <div className="grid gap-lg md:grid-cols-2">
              {/* Free Plan Card */}
              <div>
                <div className="bg-surface relative overflow-hidden rounded-2xl border text-center h-full">
                  <div className="flex flex-col gap-xl p-8 h-full">
                    ...
                    {/* CTA Button */}
                    <Button asChild size="lg" className="w-full gap-2 text-lg font-semibold">
                      <Link to={'/dashboard'} className={'hover:no-underline'}>
